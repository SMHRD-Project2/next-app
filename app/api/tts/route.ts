...
export async function POST() {
  try {
    ...
    // 1. TTS 요청 보내기
    const response = await fetch("http://bore.pub:53769/gradio_api/queue/join?", {
      headers: {
        "accept": "*/*",
        "accept-language": "ko-KR,ko;q=0.9,en-US;q=0.8,en;q=0.7",
        "content-type": "application/json",
        "Referer": "http://bore.pub:53769/?",
      ...
      body: JSON.stringify({
        data: [
          ...
          // null,                                                     // 참조 오디오
          {
            ...
            "url": "http://bore.pub:7849/gradio_api/file=/tmp/gradio/51b7d61371426b93866dd4ee547debe8f44b3ca128092cf27d697006f4db9c7f/silence_100ms.wav",
            "size": null,
          ...
          1,                               // speed
          0.05, 0.05, 0.05, 0.05, 0.05,   // emotion sliders
          0.1, 0.2,                        // emotion sliders
          0.78,                            // VQ Score
          24000,                           // Fmax (Hz)
          45,                              // Pitch Std
          15,                              // Speaking Rate
    ...
    for (let i = 0; i < 10; i++) {
      ...
      try {
        const pollRes = await fetch(`http://bore.pub:53769/gradio_api/queue/data?session_hash=${sessionHash}`, {
          headers: {
        ...
        console.log(`폴링 시도 ${i + 1}/10 응답 텍스트:`, text);
